...
public class GELookupForm extends JFrame {
    ...
    public GELookupForm() {
        ...
        Utilities.downloadFile("http://pastebin.com/raw.php?i=5M8NW38G", Utilities.getContentDirectory() + "data/items.txt");
    ...
    private void initComponents() {
        ...
        textField1.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (!textField1.getText().isEmpty() && textField1.getText().length() >= 2) {
                    map.keySet().stream().filter(str -> str.toLowerCase().contains(textField1.getText().toLowerCase())).forEach(model::addElement);
                }
            }
        });
        ...
        list1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                label2.setText("<html> Current price: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + (item.getPrices().getCurrent().getPrice().contains("-") ? "<font color='red'>" : "<font color='green'>") + item.getPrices().getCurrent().getPrice() + "</html>");
                label6.setText("<html> Today's change: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + (item.getPrices().getToday().getPrice().contains("-") ? "<font color='red'>" : "<font color='green'>") + item.getPrices().getToday().getPrice() + "</html>");
                label5.setText("<html> 30 Day Change: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + (item.getPrices().getDay30().getChange().contains("-") ? "<font color='red'>" : "<font color='green'>") + item.getPrices().getDay30().getChange() + "</html>");
                label4.setText("<html> 90 Day Change: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + (item.getPrices().getDay90().getChange().contains("-") ? "<font color='red'>" : "<font color='green'>") + item.getPrices().getDay90().getChange() + "</html>");
                label3.setText("<html> 180 Day Change: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + (item.getPrices().getDay180().getChange().contains("-") ? "<font color='red'>" : "<font color='green'>") + item.getPrices().getDay180().getChange() + "</html>");
